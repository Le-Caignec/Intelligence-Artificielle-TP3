...
class CLI_Environment:
    ...
    def GenerateFixGrid(self):
        self.grid[1][0].dust = True

        self.grid[2][0].heat = True
        self.grid[2][0].rubble = True
        
        self.grid[3][0].dust = True

        self.grid[0][1].dust = True
        
        self.grid[1][1].heat = True
        self.grid[1][1].dust = True
        self.grid[1][1].rubble = True

        self.grid[2][1].fire = True
        self.grid[2][1].dust = True
        self.grid[2][1].scream = True

        self.grid[3][1].heat = True

        self.grid[0][2].heat = True
        self.grid[0][2].dust = True
        
        self.grid[1][2].dust = True
        self.grid[1][2].rubble = True
        self.grid[1][2].scream = True

        self.grid[2][2].heat = True
        self.grid[2][2].dust = True
        self.grid[2][2].people = True

        self.grid[3][2].scream = True
        
        self.grid[0][3].fire = True
        
        self.grid[1][3].dust = True
        self.grid[1][3].heat = True
        
        self.grid[2][3].scream = True
